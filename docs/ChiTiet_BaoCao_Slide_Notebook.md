...
* **Bước 1 [ML Detection]:** 
   - Loại bỏ Canny. Dùng AI (`DocAligner` / `YOLOv8`) trích xuất biên chính xác 100%.
   - Đặc biệt: Khởi động `U²-Net` khoét xuyên khung nền nếu giấy bị lượn sóng không định hình.
* **Bước 2 [Geometric Dewarping]:** 
   - Biến đổi Phối cảnh (kéo hình thang) + Trí tuệ Nắn dòng chữ (`page-dewarp`) bẻ phẳng độ cong của sách.
* **Bước 3 [CV Enhancement]:** Tăng cường chốt chặn (Khử lóa $\rightarrow$ Kéo viền rung $\rightarrow$ Phơi sáng xám bù bóng).

### [Diễn giả - Notes]
> Từ những yếu điểm trên, nhóm đã nảy ra ý tưởng xây dựng 1 Pipeline lai (Hybrid). Thay vì vất vả dùng Toán học Canny dò từng mảnh rìa dễ đứt gãy để lấy góc, nhóm đánh thẳng AI cực mạnh như DocAligner hoặc YOLO vào Bước 1 để não bộ AI hiểu "đâu là tờ giấy" và đóng hộp mask nó, kể cả khi ngón tay đang bấm che mép. Sau khi đưa về trang giấy chuẩn bằng Dewarping Bước 2, OpenCV mới được đánh thức ở Bước 3 để đóng vai trò Bác sĩ thẩm mỹ làm sắc nét từng cụm điểm ảnh chữ.

---

### [Cell Markdown: Slide 8 - Đỉnh Cao Tăng Cường]
## ĐIỂM SÁNG CÔNG NGHỆ: SOFT BINARIZATION

**Tại sao bức ảnh xuất ra từ Pipeline của nhóm lại mềm mại như máy in thật?**
- Hệ thống **TỪ CHỐI** sử dụng Binarization đen trắng cứng ngắc (0-255).
- Áp dụng kỹ thuật: **Piecewise Linear Contrast Stretching (Phơi sáng mềm).**
  - Khóa **Black Point** kéo sập lõi chữ nhạt nhòa về đen nhanh.
  - Kích trần **White Point** tấy xóa gợn ố, rác mốc thành trắng vô cực.
  - Các Pixel màu xám trung gian ở ngưỡng giữa: Đóng vai trò lớp lót chống đứt, khử răng cưa (Anti-aliasing), bảo toàn form chữ cong tròn vẹn viền.

### [Diễn giả - Notes]
> Và điểm chốt hạ tạo ra sự khác biệt về mặt thị giác tốt nhất là Bước Phơi sáng Mềm Soft Binarization chặng cuối. Khác với Otsu chỉ có Trắng hắt / Đen xì làm vỡ mảnh vụn rìa dốc chữ. Nhóm đặt ra ngưỡng chặn 2 đầu. Kéo đen điểm đen, đẩy sáng tối đa điểm trắng. Còn giữ lại khúc giữa làm lớp sương mù xám mịn mượt lót viền biên chữ. Kết quả chữ sẽ đanh nhưng cực kì cuốn và êm mắt.
...
## THỰC NGHIỆM: CHỐNG BÓNG RÂM & PHƠI SÁNG (BƯỚC 3c, 3d)

- **Khử Bóng Râm Tuyệt Đối:** Mọi mảng tối đổ bóng lớn (điện thoại người tay người) đều bị dội sáng qua thuật toán phép chia cấu trúc (Illumination Normalization). Phông nền trở về xám bạc đồng đều 100%.
- **Option 2 Cân Bằng (Soft Binarization):** Độ rung rìa êm ái, tẩy ố mốc ngả vàng ở tài liệu lịch sử triệt để (Giấy trắng phau, nhân đen thủng).

### [Diễn giả - Notes]
> Bước cuối cùng, mọi người có thể xem bóng tay đen thui bao trùm góc giấy đã bị triệt tiêu hoàn toàn. Nền trắng phau nhưng viền không hề bị sứt mẻ lỗ rỗ. Đó là sức mạnh của Piecewise Contrast Stretching. 
