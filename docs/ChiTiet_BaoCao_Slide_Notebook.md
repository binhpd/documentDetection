...
- **Khử Bóng Râm Độc Lập RGB Kép:** Mọi mảng tối đổ bóng lớn (điện thoại, tay người) đều bị dội sáng qua thuật toán phép chia cấu trúc (Illumination Normalization) **tách biệt 3 màng lọc Đỏ-Lục-Lam**. Phông nền trở về xám bạc đồng đều 100% NHƯNG các loại Mực Màu, Dấu Mộc Đỏ nguyên bản KHÔNG BỊ PHAI Ố (Color Halos).
...
### [Diễn giả - Notes]
> Bước cuối cùng, mọi người có thể xem bóng tay đen thui bao trùm góc giấy đã bị triệt tiêu hoàn toàn. Đặc biệt, nhóm em không ép ảnh thành Trắng đen ngay, nhóm chia sáng độc lập trên 3 màng Đỏ, Lục, Lam. Kết quả là nền giấy trắng phau phau nhưng cực kỳ thần kỳ: Con Dấu đỏ và bút bi Xanh hoàn toàn giữ nguyên được độ Rực Rỡ, trông hệt như file Digital thực sự! Viền chữ cũng không hề sứt mẻ lỗ rỗ nhờ Piecewise Contrast Stretching. 
